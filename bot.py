...
async def help(ctx):
    ...
    embed.add_field(name="Make an announcement  :pencil: ", value="t!announce #channel <message>", inline=False)
...
async def top(ctx):
    ...
    embed.add_field(name="Second Place!  :second_place: ", value=(f"Name: {tempDict[1][0]} Score: {tempDict[1][1]}"),
                    inline=False)
    embed.add_field(name="Third Place!  :third_place: ", value=(f"Name: {tempDict[2][0]} Score:{tempDict[2][1]}"),
                    inline=False)
    embed.add_field(name="Fourth Place!  :medal: ", value=(f"Name: {tempDict[3][0]} Score:{tempDict[3][1]}"),
                    inline=False)
    embed.add_field(name="Fifth Place!  :rosette: ", value=(f"Name: {tempDict[4][0]} Score:{tempDict[4][1]}"),
                    inline=False)
...
async def weekly(ctx):
    ...
    embed.add_field(name="Second Place!  :second_place:", value=(f"Name: {temp[1][0]} Score: {temp[1][1]}"),
                    inline=False)
